...
public class Validator {
	...
	public static String getString(Scanner scnr, String prompt) {
		...
		System.out.print(prompt);
		return scnr.nextLine(); //next line shows us it will print entrire scentenc
	}
	...
	public static double getDouble(Scanner scnr, String prompt, double min, double max) {
		boolean isValid = false; //using as flag
		double number; //declared outside loop to declare later
		do {
			number = getDouble(scnr, prompt); //calling the gitdouble method above it
